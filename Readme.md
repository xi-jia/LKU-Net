...
* LKU-Net ranks first on the 2021 Learn2Reg Challenge Task 3 Validation dataset (see [here](https://learn2reg.grand-challenge.org/evaluation/task-3-validation/leaderboard/)) as of 18th September, 2022

* LKU-Net is also the winning entry on the 2021 Learn2Reg Challenge Task 1.  
